...
let BuyerserviceService = class BuyerserviceService {
    constructor(http) {
        ...
        this.uri = "https://resalecarmanagement.azure-api.net/api/Buyers";
        this.httpOptions = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ "Ocp-Apim-Subscription-Key": "19b704dce53a4cbfaecf24a27476e572" }) };
    }
    showBuyers() {
        // let options=new HttpHeaders({"Ocp-Apim-Subscription-Key": "19b704dce53a4cbfaecf24a27476e572"});
